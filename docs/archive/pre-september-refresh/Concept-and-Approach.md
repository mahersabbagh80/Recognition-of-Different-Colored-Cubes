...
| Path | When | What |
|------|------|------|
| **Default decision gate** | Start here | Check whether the selected Roboflow Universe model exposes raw compatible weights (`.pt` preferred); see [`archive/model-options.md`](../model-options.md) |
